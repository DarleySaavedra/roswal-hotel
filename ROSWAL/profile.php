...
<!--Logout end -->  
	...
	<hr>
      ...
      <div class="form-signin">	
          ...
          <div align="center" class="alert alert-info"><i class="icon-info-sign"></i>Información del Usuario</div>
          ...
          <div class="row-fluid">	
          	...
          	<div class="control-group">
            	...
            	<div class="controls">
                 ...
                 <p>Apellidos y Nombres: <?php echo $row['firstname']." ". $row['lastname']?></p>
                 <p>Dirección de correo: <?php echo $row['email']?></p>
                 <p>Nro Contacto: <?php echo $row['contact_number']?></p>
                 <p>Dirección: <?php echo $row['address']?></p>
                 <p>Código Postal: <?php echo $row['zip']?></p>
                 <p>País: <?php echo $row['country']?></p>
