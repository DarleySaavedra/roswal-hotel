     ...
     <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">Roswal Business Hotel</a>
          <div class="nav-collapse collapse">
            ...
            <div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                	<li class="divider"></li>
    				<li><a href="#logout" data-toggle="modal"><i class="icon-off"></i> Registrar</a></li>  
          ...
          <div class="row-fluid">	
          	...
          	<div class="control-group">
                ...
                <form action="" method="post">
						...
						$query = mysql_query("select * from tb_miembro where memberID = '$session_id'") or die (mysql_error());
						while($row = mysql_fetch_array($query)){	
						?>
              
                <div style="margin-left:-110px;">Nombre: <input disabled name="" value="<?php echo $row['firstname']." ". $row['lastname']?>" type="text"></div>
        		<div style="margin-left:-105px;">Correo: <input disabled name="" value="<?php echo $row['email']?>" type="text"></div>	
                ...
                <?php 
					...
					if(isset($_POST['send']))
					{
						...
						mysql_query("insert into tb_mensaje (memberID,message) values ('$mid','$messege')") or die(mysql_error());
