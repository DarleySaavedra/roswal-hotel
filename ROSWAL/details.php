...
function goBack()
  ...
  <li class="divider"></li>
  <li><a tabindex="-1" href="#"><strong>Consumos </strong></a></li>
  <li class="divider"></li>
  <li><a tabindex="-1" href="#"><span class="text-info">Total:</span> S/. <?php echo $total;?>.00</a></li>
  <li><a tabindex="-1" href="#"><span class="text-info">Adelanto:</span> S/. <?php echo $pre;?>.00</a></li>
  <li><a tabindex="-1" href="#"><span class="text-info">Pendiente:</span> S/. <?php echo $bal;?>.00</a></li>
  <li><a tabindex="-1" href="#"><span class="text-info">Impuesto:</span> S/. <?php echo $tax;?>.00</a></li>
  <li class="divider"></li>
  <li><a tabindex="-1" href="#"><strong>Habitaciones</strong></a></li>
  <li class="divider"></li>
  <li><a tabindex="-1" href="#"><span class="text-info">Habit. ID.</span> <?php
    ...
    <!-- dropdown menu links -->
        ...
        <h4>Paso 4: Información del Cliente</h4>
        	<hr>
            <table width="503">
            	...
            	<tr>
                	...
                	<td width="270">Nombres:<input class="validate[required,custom[onlyLetterSp]] text-input" name="fname" type="text" id="req" ></td>
                    
            		<td width="221">Apellidos:<input class="validate[required,custom[onlyLetterSp]] text-input" name="lname" type="text" id="req2"></td>
                ...
                <tr>
                	...
                	<td>Correo:<input class="validate[required,custom[email]] text-input" name="email" id="email" type="text"></td>
                    <td>Confirmar Correo:<input class="validate[required,equals[email]] text-input" name="cemail" id="email2" type="text"></td>
                ...
                <td>Usuario:<input  name="user" type="text" id="user"/></td>
                
                <!-- class="validate[required,custom[onlyLetterNumber],maxSize[20],ajax[ajaxUserCallPhp]] text-input" -->	
                    <td>No Contacto:<input value="" class="validate[required,[maxSize[9],custom[onlyNumberSp],[minSize[9]] text-input" name="cnumber" maxlength="9" type="text" id="telephone"></td>
                 ...
                 <tr>
                	...
                	<td>Clave:<input class="validate[required,minSize[6]] text-input" name="password" id="password" type="password"></td>
                    <td>Retipee Clave:<input class="validate[required,minSize[6],equals[password]] text-input" name="password2" id="password2" type="password"></td>
                 ...
                 <tr>
                    ...
                    <td>Código Zip:<input class="validate[required,custom[onlyNumberSp]] text-input" name="zip" type="text" id="onlynumber"/></td>
                ...
                <tr>
                    ...
                    <td><input class="validate[required] checkbox" type="checkbox" id="agree" name="agree"/> <span style=" font-size:12px">Estoy de acuerdo y acepto <a href="#myModal" data-toggle="modal">Términos y condiciones</a></span></td>
  ...
  <div style="margin-top:20px;" class="accordion-group">
    <div class="accordion-heading">
      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
        <i class="icon-user"></i> Area Usuarios
      </a>
    </div>
...
<div class="control-group">
                    ...
                    <div class="control-group">
                    	<div class="controls">
						<button class="btn" type="submit" name="order_login"><i class="icon-check"></i> Ingresar</button>
						</div>
                    </div>    
                </div>
