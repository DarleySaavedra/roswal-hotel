<?php include('header.php');?>
	...
	<link href="css/datepicker.css" rel="stylesheet" type="text/css" />
		...
		*/
		...
		if (x==null || x=="")
		  {
		  alert("Debe ingresar su fecha de registro(Haga clic en el icono del calendario)");
		  return false;
		  }
		var y=document.forms["index"]["end"].value;
		if (y==null || y=="")
		  {
		  alert("Debe ingresar su fecha de salida (Haga clic en el icono de calendario)");
		  return false;
		  }
		}
		</script>
...
<?php include('header.php'); ?>
  ...
  <body>
    ...
    <div class="container-narrow">
   	...
   	<button style="margin-bottom:-80px;" class="btn" onClick="goBack()"><i class="icon-hand-left"></i> Volver</button>
      <hr>
      ...
      <div class="jumbotron">
        ...
        <p class="lead"><img src="media/kingsfields.png" width="150" height="150"></p>
					  ...
					  <span style="margin-right: 5px; color:rgba(0,0,0,1);">Fecha de inicio: <input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" placeholder="Llegada" name="start" id="sd" value="" maxlength="10" readonly style="width: 210px; margin-left: 15px; border: 1px double #CCCCCC; padding:5px 10px;"/></span><br>
						<span style="margin-right: 5px; color:rgba(0,0,0,1);">Fecha final:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" placeholder="Salida" name="end" id="ed" value="" maxlength="10" readonly style="width: 210px; margin-left: 23px; border: 1px double #CCCCCC; padding:5px 10px;" /></span><br>
						<input type="hidden" name="result" id="result" /><br>
                        
                    
        <div align="center"> 	
<button type="submit" onClick="setDifference(this.form);" class="btn btn-info"><i class="icon-check"></i> VERIFICAR DISPONIBILIDAD</button>
       </div>
     ...
     <span style="margin-bottom:-80px; margin-left:603px;" class="btn">Proceder <i class="icon-hand-right"></i></span>
      ...
      <div class="footer">
        <p>&copy; Kingsfield Express Inn 2017</p>
      </div>
